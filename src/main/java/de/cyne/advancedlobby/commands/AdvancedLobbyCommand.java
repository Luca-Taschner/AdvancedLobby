                ...
                if (args[0].equalsIgnoreCase("location") | args[0].equalsIgnoreCase("loc")) {
                    if (args[1].equalsIgnoreCase("list")) {
                        ...
                        for (String location : locations) {
                            ...
                            teleport.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("§8► §7Click to teleport to §8'§b" + location + "§8'").create()));
                            ...
                            remove.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("§8► §7Click to remove §8'§b" + location + "§8'").create()));
