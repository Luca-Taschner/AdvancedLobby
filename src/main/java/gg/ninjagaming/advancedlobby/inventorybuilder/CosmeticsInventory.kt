...
object CosmeticsInventory {
    ...
    private fun buildInventory(): Inventory {
        ...
        val balloonsItemStack = ItemBuilder(VMaterial.LEAD.type)
        ...
        for (i in 0..8) {
            inventory.setItem(i, ItemBuilder(VMaterial.BLACK_STAINED_GLASS_PANE.toItemStack()).setDisplayName("§r").build())
        }
